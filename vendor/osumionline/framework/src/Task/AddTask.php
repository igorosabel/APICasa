...
class addTask extends OTask {
	...
	private function createModelComponent(array $params): void {
		...
		$values['list_folder']        = $this->getConfig()->getDir('app_component').'Model/'.$values['model_name'].'ListComponent/';
		...
		$values['component_folder']        = $this->getConfig()->getDir('app_component').'Model/'.$values['model_name'].'Component/';
