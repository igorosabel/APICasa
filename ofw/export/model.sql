...
ALTER TABLE `message_tag`
  ADD KEY `fk_message_tag_asset_idx` (`id_message`),
  ADD KEY `fk_message_tag_tag_idx` (`id_tag`),
  ADD CONSTRAINT `fk_message_tag_asset` FOREIGN KEY (`id_message`) REFERENCES `asset` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_message_tag_tag` FOREIGN KEY (`id_tag`) REFERENCES `tag` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;


ALTER TABLE `invite`
  ADD KEY `fk_invite_user_idx_from` (`from`),
  ADD KEY `fk_invite_user_idx_to` (`to`),
